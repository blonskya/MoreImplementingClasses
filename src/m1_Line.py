...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.clnum = 0
        self.truestart = start.clone()
        self.trueend = end.clone()
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # --------------------------------------------------------------
        ender=other_line.clone()
        ender.start=ender.start.plus(self.start)
        ender.end=ender.end.plus(self.end)
        return ender
